    ...
    createCard() {
        ...
        const recipeCard =`<div class="card">
                    ...
                    <div class="card-body bg-gray px-3 pt-3 pb-0">
                        ...
                        <span class="font-weight-bold d-inline-block recipe-time"><i class="bi bi-clock"></i> ${this._recipe.time} min</span></p>
...
function noRecipe() {
    ...
    const norecipeCard =`<p class="bg-gray p-3">« Aucune recette ne correspond à votre critère... vous pouvez chercher « tarte aux pommes », « poisson », etc.</p>`
